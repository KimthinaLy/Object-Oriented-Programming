/*1. Create a class called "Point" that exists of private attributes, constructor, destructor, fuction get, fuctoin set, fuction show
2. Create a function that counts the number of obj existed in the program
3. Create function "dot" to the dot product of an object, and function "midPoint" to return the middle point between 2 points of an obj
4. Test all existing functions in main
*/
