...
public:
   ...
   char newChar[30];
        cout<<"Input person id: "; is>>newChar;
        setId(newChar);
        cout<<"Input person firstName: "; is>>firstName;
        cout<<"Input person lastName: "; is>>lastName;
        int newDay,newMonth,newYear;
        setDate(Date());
        cout<<"Input day of birth: "; is>>newDay;
        date.setDay(newDay);
        cout<<"Input month of birth: "; is>>newMonth;
        date.setMonth(newMonth);
        cout<<"Input year of birth: "; is>>newYear;
        date.setYear(newYear);
        char newHouseNo[30],newRoad[30],newVill[30],newSubDis[30],newDistr[30],newProv[30];
        int newPostCode;
        cout<<"Enter house number: "; is>>newHouseNo;
        cout<<"Enter road: "; is>>newRoad;
        cout<<"Enter village: "; is>>newVill;
        cout<<"Enter subDistrict: "; is>>newSubDis;
        cout<<"Enter district: "; is>>newDistr;
        cout<<"Enter province: "; is>>newProv;
        cout<<"Enter postCode: "; is>>newPostCode;
